...
#
# Generated by export_simulation on Mon Apr 02 13:39:51 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './mul_1.sh' script.
...
./mul_1.sh -noclean_files

For more information on the script, please type './mul_1.sh -help'.
