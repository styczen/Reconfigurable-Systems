...
#
# Generated by export_simulation on Sat Apr 07 23:04:19 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './add_D_E.sh' script.

./add_D_E.sh -reset_run
...
./add_D_E.sh -noclean_files

For more information on the script, please type './add_D_E.sh -help'.
