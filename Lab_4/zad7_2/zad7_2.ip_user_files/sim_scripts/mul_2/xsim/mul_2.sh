...
#
# Generated by Vivado on Sat Apr 07 23:09:06 +0200 2018
# SW Build 2086221 on Fri Dec 15 20:55:39 MST 2017
#
# Copyright 1986-2017 Xilinx, Inc. All Rights Reserved. 
#
# usage: mul_2.sh [-help]
# usage: mul_2.sh [-lib_map_path]
# usage: mul_2.sh [-noclean_files]
# usage: mul_2.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "mul_2.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_8 -L xbip_pipe_v3_0_4 -L xbip_bram18k_v3_0_4 -L mult_gen_v12_0_13 -L xil_defaultlib -L secureip -L xpm --snapshot mul_2 xil_defaultlib.mul_2 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mul_2 -key {Behavioral:sim_1:Functional:mul_2} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./mul_2.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mul_2.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./mul_2.sh -help\" for more information)\n"
    exit 1
  fi
