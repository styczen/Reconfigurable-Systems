...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/Lab_5/vp_bin/vp_bin.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vp_bin_c.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vp_bin_c.tcl
