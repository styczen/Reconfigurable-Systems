...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/13/1/soft_processor/soft_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soft_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soft_processor.tcl
