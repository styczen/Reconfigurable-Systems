...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/Lab_5/8_5/8_5.runs/vp_bin_c_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vp_bin_c_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vp_bin_c_0.tcl
