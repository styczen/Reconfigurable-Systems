...
void simulate(char *dp)
{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 706792, dp + 648952, 0, 31, 0, 31, 32, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 652008, dp + 649008, 0, 31, 0, 31, 32, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 764344, dp + 762256, 0, 51, 0, 51, 52, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 879224, dp + 877136, 0, 51, 0, 51, 52, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 993168, dp + 991856, 0, 10, 0, 10, 11, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053768, dp + 991912, 0, 10, 0, 10, 11, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1114368, dp + 991968, 0, 21, 0, 21, 22, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1128536, dp + 992024, 0, 21, 0, 21, 22, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1142704, dp + 992080, 0, 21, 0, 21, 22, 1);
