...
#
# Generated by export_simulation on Sat Jun 09 11:04:48 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './bounding_box_0.sh' script.

./bounding_box_0.sh -reset_run
...
./bounding_box_0.sh -noclean_files

For more information on the script, please type './bounding_box_0.sh -help'.
