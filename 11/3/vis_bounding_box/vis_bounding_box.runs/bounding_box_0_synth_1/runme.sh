...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/11/3/vis_bounding_box/vis_bounding_box.runs/bounding_box_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bounding_box_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bounding_box_0.tcl
