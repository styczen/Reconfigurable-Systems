...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/11/3/vis_bounding_box/vis_bounding_box.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vis_bounding_box.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vis_bounding_box.tcl
