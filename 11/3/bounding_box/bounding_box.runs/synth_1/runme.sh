...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/11/3/bounding_box/bounding_box.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bounding_box.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bounding_box.tcl
