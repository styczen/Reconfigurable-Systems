...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/Lab_3/UART_state_machine/UART_state_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_state_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_state_machine.tcl
