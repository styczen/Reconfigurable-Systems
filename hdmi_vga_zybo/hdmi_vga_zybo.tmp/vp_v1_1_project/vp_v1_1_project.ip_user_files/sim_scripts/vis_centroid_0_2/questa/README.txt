...
#
# Generated by export_simulation on Wed Jun 06 11:48:38 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './vis_centroid_0.sh' script.

./vis_centroid_0.sh -reset_run
...
./vis_centroid_0.sh -noclean_files

For more information on the script, please type './vis_centroid_0.sh -help'.
