...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/Lab_4/zad7_2/zad7_2.runs/add_D_E_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_D_E.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_D_E.tcl
