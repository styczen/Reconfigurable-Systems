...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/Lab_2/Complex_logic_module/Complex_logic_module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complex_logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source complex_logic.tcl
