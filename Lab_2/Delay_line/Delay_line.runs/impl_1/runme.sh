...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/Lab_2/Delay_line/Delay_line.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log delay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source delay.tcl -notrace
