...
HD_PWD='C:/Users/Bartek/Reconfigurable-Systems-Laboratory-Class/Lab_2/Long_and_gate/lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log long_and_gate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source long_and_gate.tcl
