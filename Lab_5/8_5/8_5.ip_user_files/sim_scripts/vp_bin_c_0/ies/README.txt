...
#
# Generated by export_simulation on Tue Apr 24 14:46:27 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './vp_bin_c_0.sh' script.

./vp_bin_c_0.sh -reset_run
...
./vp_bin_c_0.sh -noclean_files

For more information on the script, please type './vp_bin_c_0.sh -help'.
